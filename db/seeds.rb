...
Category.create(name: 'Brewery', tags: { 'cuisine'=>'brewery' }, icon: 'restaurant', parent: restaurants)
...
Category.create(name: 'Dessert', tags: { 'cuisine'=>'dessert' }, icon: 'restaurant', parent: restaurants)
...
Category.create(name: 'Ramen', tags: { 'cuisine'=>'ramen' }, icon: 'noodle-house', parent: restaurants)
